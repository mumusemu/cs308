	...
	<div class="navbar navbar-inverse navbar-fixed-top">
		...
		<div class="collapse navbar-collapse" id="collapse">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="customer_registration.php?register=1" style="color:white"><span class="glyphicon glyphicon glyphicon-user"></span> Sign Up</a></li>
			
				<li><a href="#" style="color:white" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart"></span> Cart <span class="badge">0</span></a>
				...
				<li><a href="#" style="color:white" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-log-in"></span> Login</a>
